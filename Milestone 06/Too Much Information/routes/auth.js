...
import {toAuthUser , toProfileUser} from '../utils/authUtils.js';
...
router.post('/login', async (req, res) => {
  ...
  try {
    ...
    const result = await pool.query('SELECT id, name, email, role, password_hash, subscription_plan FROM users WHERE email = $1', [email]);
